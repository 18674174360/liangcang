    ...
    if(cartList4.length>0){
        ...
        cartList4.forEach(item=>{
            ...
            <div class="media">
                ...
                <a href="#">
                    <img class="media-object" src="${item.tupian}" width="100" height="100">
                </a>
                </div>
                <div class="media-body width1">
                <h4 class="media-heading">${item.zishang}</h4>
                <p>${item.zixia}</p>
...
function total(){
    ...
    cartList4.forEach(item=>{
        ...
        if(item.is_select==1){
            ...
            prices+=parseFloat(item.jiage)*parseInt(item.cart_number)
        }
    })
    return [nums,prices]
}